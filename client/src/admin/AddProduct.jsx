...
const AddProduct = () => {
    ...
    const newPostForm = () => (
        <form className="mb-3" onSubmit={handleSubmit}>
            <h4 className='lead'>Upload Product Photo</h4>
            <div className="form-group">
                <label className="btn rounded btn-primary">
            ...
            <button className="btn rounded btn-outline-primary">Create Product</button>
        </form>
    );

    const showSuccess = () => (
        <div className="alert alert-info" style={{ display: createdProduct ? '' : 'none' }}>
            <h2 className='lead'>{`${name}`} is created!</h2>
        </div>
    );
    ...
    const showLoading = () => (
        loading && (
            <div className="lead alert alert-success">
                <h2>Loading...</h2>
            </div>
        )
    );
    ...
    const goBack = () => (
        <div className="mt-4 mb-2">
            <Link to="/admin/dashboard" className="btn rounded btn-warning">
                Back to dashboard
            </Link>
        </div>
    )
