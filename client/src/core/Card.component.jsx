...
const Card = ({ 
        ...
        return (
            showViewProductButton && (
                <Link to={`/product/${product._id}`}>
                    <button className="btn rounded btn-outline-dark .mt-2 mb-2 mr-2">
                        View Product
                    </button>
                </Link>
            )
    ...
    const showAddToCart = (showAddToCartButton) => {
        return ( showAddToCartButton && (
            <button onClick={addToCart} className="btn rounded btn-outline-dark mt-2 mb-2">
                Add To Cart
            </button>
        ));
    };
    ...
    const showRemove = (showRemoveProductButton) => {
        return ( showRemoveProductButton && (
            <button 
                ...
                className="btn rounded btn-outline-danger mt-2 mb-2">
                Remove Product
            </button>
        ));
    };
    ...
    return (
            <div className="ml-5 card text-center">
