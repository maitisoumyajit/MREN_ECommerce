...
const Shop = () => {
    ...
    return (
        <Layout title="Online Shopping Made Easy!" description="Shop your favourite show's merchandise to show some support..." className="container-fluid">
            <div className="row">
                <div className="col-4">
                    <h4 className='lead'><strong>Filter by categories</strong></h4>
                    <ul>
                        <Checkbox categories={categories} handleFilters={ filters => handleFilters(filters, 'category')}/>
                    </ul>

                    <h4 className='lead'><strong>Filter by &#x20b9; price range</strong></h4>
                    <div>
                        <RadioButton prices={prices} handleFilters={ filters => handleFilters(filters, 'price')}/>
                    </div>
                </div>
                <div className="col-8">
                    <h2 className="mb-5 display-4">Products</h2>
                    <div className="row">
                        {showError(error)}
