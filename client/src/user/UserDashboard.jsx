...
const Dashboard = () => {
    ...
    const userLinks = () => {
        return (
            <div className="card">
                <h4 className="card-header display-4">User Links</h4>
                <ul className="list-group nav-link">
    ...
    const userInfo = () => {
        return (
            <div className="card mb-5">
                <h3 className="card-header display-4">User Information</h3>
                <ul className="list-group nav-link">
    ...
    const purchaseHistory = (history) => {
        return (
            <div className="card mb-5">
                <h3 className="card-header display-4">Purchase history</h3>
